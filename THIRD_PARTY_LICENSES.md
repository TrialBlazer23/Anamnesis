...
| David Chamberlain, Iliad/Odyssey recitations (hypotactic.com) — planned audio packs; manifest at `pipeline/data/audio/` | **CC BY — confirmed from the primary source**: "Audio and text annotations licensed as CC-BY, © 2016, 2017 by David Chamberlain" (evidence: `docs/licensing-evidence/hypotactic-homer-audio-cc-by.png`) | Attribution: "© 2016–2017 David Chamberlain, hypotactic.com, CC BY"; indicate changes (e.g. re-encoding) |
